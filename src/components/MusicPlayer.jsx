import React, { useState, useRef, useEffect } from 'react';
    ...
    const defaultSongs = [
      ...
      { title: 'LOS_VOLTAJE__Slowed', src: '/music/LOS_VOLTAJE__Slowed.mp3', artist: 'Phonk' },
      { title: 'Eternxlkz_-_BRODYAGA_FUNK', src: '/music/Eternxlkz_-_BRODYAGA_FUNK__Official_Audio.mp3', artist: 'PureOjuice' },
      { title: 'Blakaza_Demon_Slayer_Akaza_Uk_Drill_Rengoku_Diss, src: '/music/Pureojuice_-_Blakaza___Demon_Slayer_Akaza_Uk_Drill__Rengoku_Diss__@MusicalityMusic.mp3', artist: 'PureOjuice' },
      { title: 'Gear_5_Luffy_UK_Drill_(One_Piece)_Kaido_Diss_''Drums_Of_Liberation''', src: '/music/Gear_5_Luffy_UK_Drill_(One_Piece)_Kaido_Diss_''Drums_Of_Liberation''.mp3', artist: 'PureOjuice' }
    ];
